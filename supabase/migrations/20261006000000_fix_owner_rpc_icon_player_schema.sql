-- Supabase Forward Migration: 20261006000000_fix_owner_rpc_icon_player_schema.sql
-- Target: Supabase Postgres DB
-- Application: Cricket Player Registration & Payment Web Application
-- Description: Gate 3-R1 STEP 1C Fix allocate_owner_registration_v3 Icon player INSERT schema mismatch
--
-- Fix: Remove registration_reference from INSERT INTO players in allocate_owner_registration_v3.
--      The players table holds core identity profiles and does not have a registration_reference column.
--      All canonical architecture, owner/icon capacity rules, snapshot casts, and payment breakdown logic are preserved.
